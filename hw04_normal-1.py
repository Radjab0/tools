...
print('Символы в нижнем регистре с использовани "re": \n',line_str)
...
for i, element in enumerate(new_line[:]):
    for element_2 in symbol:
        if element == element_2:
            new_line[i] = ' '
# Соединение списка в строку методом .join
list_1 = ''.join(new_line).split(' ')
 
line_2 = [i for i in list_1 if i != '']
print('Символы в нижнем регистре без использования "re": \n',line_2)
